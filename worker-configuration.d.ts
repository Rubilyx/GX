/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env=test` (hash: cd20b10fff5d7f2ffcb0fd300aa5f111)
// Runtime types generated with workerd@1.20260722.1 2026-07-29 
interface __BaseEnv_Env {
	THREADS_MEDIA: R2Bucket;
	PROD_DB: D1Database;
	THREADS_CAPTURE_QUEUE: Queue;
	THREADS_MEDIA_QUEUE: Queue;
	...
	PROD_IP_HMAC_KEY: string;
	PROD_PIN_DIGEST: string;
	PROD_PIN_SALT: string;
	PROD_SESSION_KEY: string;
	THREADS_APP_SECRET: string;
	THREADS_TOKEN_KEY: string;
	PROVIDER_FIXTURE: Fetcher /* provider-fixture */;
}
